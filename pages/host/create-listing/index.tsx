                      ...
                      descr={
                        <div>
                          <Typography variant="subtitle1" gutterBottom>
                            Điều này là cần thiết khi bạn sở hữu nhiều căn hộ trong cùng một tòa nhà
                          </Typography>
                          <img
                            src="../../../static/images/apartment.jpg"
                            alt="westay.vn"
                  ...
                  <Grid item xs={12}>
                    <RadioCustom
                      ...
                      descr={
                        <div>
                          <Typography variant="subtitle1" gutterBottom>
                            Lựa chọn này khi bạn có những căn hộ riêng biệt
                          </Typography>
                          <img
                            src="../../../static/images/studio.jpg"
                            alt="westay.vn"
                            className={classes.imgType}
                          />
                        </div>
