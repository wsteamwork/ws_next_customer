...
export const getRoomHot = async (initLanguage: string): Promise<RoomIndexRes[]> => {
...
export const getRoomCity = async (initLanguage: string): Promise<NumberRoomCity[]> => {
  const query: Partial<RoomIndexGetParams> = {
    hot: 1
  };
...
// export const getRoomNew = async (initLanguage: string): Promise<RoomIndexRes[]> => {
//   const query: Partial<RoomIndexGetParams> = {
...
export const getApartments = async (initLanguage: string): Promise<TypeApartment[]> => {
...
// export const getCollections = async (initLanguage: string): Promise<Collections[]> => {
