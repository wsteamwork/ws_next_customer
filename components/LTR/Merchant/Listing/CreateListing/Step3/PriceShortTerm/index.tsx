...
const PriceShortTerm: FC<IProps> = (props) => {
  ...
  const [price, setPrice] = useState<IPriceShortTerm>({
    rent_type: listing.short_term_rent_type.rent_type,
  ...
  const changePrice = (name: keyof IPriceShortTerm) => (event: React.ChangeEvent<HTMLInputElement>) => {
    setPrice({
      ...price,
        ...
        <div>
          ...
          <Grid container justify='center'>
            <Grid item xs={11}>
              ...
              <Typography className={classes.subTitle} variant='subtitle2' gutterBottom>
                Đây là giá phụ thu khi tăng thêm mỗi khách, hệ thống sẽ tự động tính vào tiền đặt căn hộ của khách.
              </Typography>
