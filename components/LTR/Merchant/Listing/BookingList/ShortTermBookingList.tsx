                    ...
                    <TableRow key={i} className={classes.tableRow}>
                      ...
                      <Hidden xsDown>
                        ...
                        <TableCell className={classes.tableValue}>
                          ...
                          {booking.payment_status === 0 && (
                            <Typography variant="subtitle2" className={classes.statusBookWaiting}>
                              {booking.payment_status_txt}
                            </Typography>
                          )}
                          {booking.payment_status === 3 && (
                            <Typography variant="subtitle2" className={classes.statusBookSuccess}>
                              {' '}
                              {booking.payment_status_txt}
                            </Typography>
                          )}
                          {booking.payment_status !== 0 && booking.payment_status !== 3 && (
                            <Typography variant="subtitle2" className={classes.statusBookCancel}>
                              {booking.payment_status_txt}
                            </Typography>
                          )}
                        </TableCell>
